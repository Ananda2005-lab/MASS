...
const CONFIG = {
  nova: {
    ...
    title: "Nova",
    tag: "INTELLIGENCE",
    desc: "Give an instruction — Nova plans, runs agents and tools, verifies every result, and completes the task.",
  ...
  forge: {
    ...
    title: "Forge",
    tag: "WORKSPACE",
    desc: "Work alongside the agent — files, research, tools and execution in live panels, all under your control.",
